...
typedef enum
{
    ...
    COAP_METHOD_FETCH = 5,      // ADD THIS
    COAP_METHOD_PATCH = 6,      // ADD THIS
    COAP_METHOD_iPATCH = 7      // ADD THIS
} coap_method_t;
...
typedef enum
{
    ...
    COAP_RSPCODE_UNSUPPORTED_CONTENT_FORMAT = MAKE_RSPCODE(4, 15),     // 4.15 ✅
